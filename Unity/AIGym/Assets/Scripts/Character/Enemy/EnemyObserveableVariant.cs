...
public class EnemyObserveableVariant : MonoBehaviour
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(EnemyObserveableVariant))]
public class EnemyObserveableVariantEditor : Editor
{
    public override void OnInspectorGUI()
    {
        var npc = (EnemyObserveableVariant)target;
